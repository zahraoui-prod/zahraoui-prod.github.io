            ...
            <form onSubmit={handleSubmit} className="space-y-6 bg-card/50 backdrop-blur-sm p-8 rounded-lg border border-primary/20">
              <div>
                ...
                <Input
                  ...
                  required
                  className="bg-background border-primary/30 text-foreground placeholder:text-foreground/50"
                />
              </div>
              ...
              <div>
                ...
                <Textarea
                  ...
                  required
                  rows={5}
                  className="bg-background border-primary/30 text-foreground placeholder:text-foreground/50 resize-none"
                />
              </div>
              ...
              >
                {submitStatus === 'loading' ? (language === 'en' ? 'Sending...' : 'جاري الإرسال...') : t.sendButton}
              </Button>
